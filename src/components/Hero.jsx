...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative w-full overflow-hidden    pt-[80px] min-h-[100svh] md:min-h-[80vh] lg:min-h-[100svh]"
    ...
    >
     ...
     <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 flex items-center min-h-[calc(100vh-80px)] pl-8 sm:pl-12 lg:pl-24 pr-6">
